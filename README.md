...
<p>Durante a criação foram utilizadas tags HTML semânticas, propriedade CSS flex, posicionamento de elementos, responsividade e manipulação de CSS com Javascript. Para mais detalhes de implementação, o vídeo está disponível no Youtube.</p>
...
<p>Layout 1</p>
<a align="center" href="">
<img alt="Primeiro layout. Mostra todas as tags HTML semânticas abaixo da outra que quando nas telas do smartphone o menu fica oculto e é exibido ao passar por cima do botão de menu no canto superior direito." src="github_img/layout_1.gif">
</a>
